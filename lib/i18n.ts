...
const es: Dict = {
  ...
  features: [
    ...
    { title: "Entrega inmediata", desc: "Tu servicio comienza a llegar entre 10 minutos y 2 horas después de tu compra." },
  ...
  order: {
    ...
    followersBenefits:
      "🛡️ 90 días de garantía · 📉 Muy poca caída · 🔒 Sin contraseña · ⚡ Entrega inmediata",
  ...
  gracias: {
    ...
    deliveryEta: "Tu servicio se entregará entre 10 minutos y 2 horas.",
    gradualTitle: "¿Por qué entre 10 min y 2 horas? 🛡️",
    gradualDesc: "No lo hacemos de golpe a propósito. Instagram y TikTok tienen algoritmos que detectan picos de crecimiento bruscos y pueden marcar la cuenta. Nuestro sistema entrega de forma gradual, simulando crecimiento orgánico natural. Así el resultado es más duradero, tu cuenta queda 100% protegida y el algoritmo lo toma como crecimiento real.",
    ...
    usdtDeliveryNote: "Una vez que confirmemos tu pago, comenzamos la entrega: entre 10 minutos y 2 horas, de forma gradual para proteger tu cuenta.",
...
const pt: Dict = {
  ...
  features: [
    ...
    { title: "Entrega imediata", desc: "Seu serviço começa a chegar entre 10 minutos e 2 horas após a compra." },
  ...
  order: {
    ...
    followersBenefits:
      "🛡️ 90 dias de garantia · 📉 Queda mínima · 🔒 Sem senha · ⚡ Entrega imediata",
