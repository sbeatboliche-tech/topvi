...
export default function LiveFeed({ bought, agoText, names, cities, services }: Props) {
  ...
  return (
    <div
      className={`fixed bottom-20 left-4 z-40 flex max-w-[280px] items-center gap-3 rounded-2xl border border-border bg-surface/95 p-3 shadow-xl shadow-black/40 backdrop-blur transition-all duration-500 md:bottom-5 md:left-5 ${
