...
const es: HomeCopy = {
  hero: {
    ...
    bullets: [
      "⚡ Entrega total en menos de 3 hs",
  ...
  steps: {
    ...
    items: [
      ...
      { emoji: "🚀", title: "3. Mira cómo crece", desc: "Pagas seguro y lo recibís en menos de 3 hs." },
    ],
  },
  packs: {
    ...
    perks: [
      ["Entrega en menos de 3 hs", "Sin contraseña", "Garantía de reposición", "Soporte en tiempo real"],
      ["Entrega en menos de 3 hs", "Sin contraseña", "Garantía de reposición", "Soporte en tiempo real", "Seguidores de regalo"],
      ["Entrega en menos de 3 hs", "Sin contraseña", "Garantía de reposición", "Soporte prioritario", "Seguidores de regalo"],
    ],
...
const ar: HomeCopy = {
  ...
  steps: {
    ...
    items: [
      ...
      { emoji: "🚀", title: "3. Mirá cómo crece", desc: "Pagás seguro y lo recibís en menos de 3 hs." },
    ],
  },
  reviews: {
    ...es.reviews,
...
const pt: HomeCopy = {
  hero: {
    ...
    bullets: [
      "⚡ Entrega total em menos de 3 hs",
  ...
  steps: {
    ...
    items: [
      ...
      { emoji: "🚀", title: "3. Veja crescer", desc: "Pague com segurança e você recebe em menos de 3 hs." },
    ],
  },
  packs: {
    ...
    perks: [
      ["Entrega em menos de 3 hs", "Sem senha", "Garantia de reposição", "Suporte em tempo real"],
      ["Entrega em menos de 3 hs", "Sem senha", "Garantia de reposição", "Suporte em tempo real", "Seguidores de brinde"],
      ["Entrega em menos de 3 hs", "Sem senha", "Garantia de reposição", "Suporte prioritário", "Seguidores de brinde"],
    ],
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Quanto tempo demora?", a: "A entrega é concluída em menos de 3 horas, de forma gradual para parecer natural." },
