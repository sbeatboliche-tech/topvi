...
const es: Dict = {
  ...
  steps: [
    ...
    { title: "Paga seguro", desc: "Con MercadoPago o USDT. Pago protegido." },
  ...
  order: {
    ...
    contactPh: "tu@email.com o +54 9 11...",
    summary: "Resumen",
    service: "Servicio",
    qualityW: "Calidad",
    bonus: "Bonus gratis",
    ...
    usdtDesc: "Pago en USDT. Te pasamos la wallet al confirmar.",
  ...
  gracias: {
    ...
    usdtTitle: "Paga con USDT para completar",
...
const ar: Dict = {
  ...
  steps: [
    ...
    { title: "Pagá seguro", desc: "Con MercadoPago o USDT. Pago protegido." },
...
const pt: Dict = {
  ...
  steps: [
    ...
    { title: "Pague com segurança", desc: "Com MercadoPago ou USDT. Pagamento protegido." },
  ...
  order: {
    ...
    usdtDesc: "Pagamento em USDT. Enviamos a carteira ao confirmar.",
  ...
  gracias: {
    ...
    usdtTitle: "Pague com USDT para concluir",
