...
const content = {
  es: {
    ...
    steps: [
      ...
      { title: "Recibís todo", desc: "La entrega total se completa en menos de 3 horas, de forma gradual y natural." },
  ...
  pt: {
    ...
    steps: [
      ...
      { title: "Receba tudo", desc: "A entrega total se completa em menos de 3 horas, de forma gradual e natural." },
