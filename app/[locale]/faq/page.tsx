...
const content = {
  es: {
    ...
    faqs: [
      ...
      { q: "¿Cuánto tarda la entrega?", a: "Normalmente entre 0 y 6 horas. En momentos de mucha demanda puede tardar hasta 12 horas." },
      { q: "¿Los seguidores se caen?", a: "Puede haber una caída mínima natural. Por eso incluimos garantía (30 a 60 días) y reponemos las caídas sin costo." },
      { q: "¿Mi cuenta tiene que estar pública?", a: "Sí, hasta que recibas el pedido completo. Luego podés volver a hacerla privada." },
      { q: "¿Qué diferencia hay entre Global y Premium?", a: "Global es la opción económica de calidad estándar. Premium son cuentas de altísima calidad, con menor caída, garantía más larga y regalo." },
      { q: "¿Cómo puedo pagar?", a: "Con MercadoPago (tarjeta, dinero en cuenta, hasta 3 cuotas) o con USDT." },
      { q: "¿Es seguro? ¿Me pueden banear?", a: "El proceso es externo y gradual, simulando crecimiento natural. No accedemos a tu cuenta." },
    ],
  ...
  pt: {
    ...
    faqs: [
      ...
      { q: "Quanto tempo leva a entrega?", a: "Normalmente entre 0 e 6 horas. Em momentos de muita demanda pode levar até 12 horas." },
      { q: "Os seguidores caem?", a: "Pode haver uma queda mínima natural. Por isso incluímos garantia (30 a 60 dias) e repomos sem custo." },
      { q: "Minha conta precisa estar pública?", a: "Sim, até receber o pedido completo. Depois pode voltar a deixá-la privada." },
      { q: "Qual a diferença entre Global e Premium?", a: "Global é a opção econômica padrão. Premium são contas de altíssima qualidade, com menor queda, garantia mais longa e brinde." },
      { q: "Como posso pagar?", a: "Com MercadoPago (cartão, saldo, parcelado) ou com USDT." },
      { q: "É seguro? Posso ser banido?", a: "O processo é externo e gradual, simulando crescimento natural. Não acessamos sua conta." },
    ],
